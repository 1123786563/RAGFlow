  ...
  translation: {
    ...
    departments: {
      ...
      form: {
        ...
        rootNode: '根节点',
        location: '部门位置',
        locationPlaceholder: '请输入部门位置',
        tokenLimit: 'Token限额',
        tokenLimitPlaceholder: '请输入Token限额',
        storageLimit: '存储限额',
        storageLimitPlaceholder: '请输入存储限额',
      },
      edit: {
        title: '编辑部门',
      },
...
[在此处插入文本]`,
    ...
    admin: {
      ...
      deleteUser: '删除用户',
      deleteUserConfirmation: '您确定要删除此用户吗？',
      ...
      passwordMinLength: '密码必须超过8个字符。',
      confirmPasswordRequired: '请确认您的密码！',
      confirmPasswordDoNotMatch: '您输入的密码不匹配！',
      ...
      importFileTips: '文件必须包含一个名为<code>email</code>的标题列。',
      ...
      deleteRole: '删除角色',
      deleteRoleConfirmation: '您确定要删除此角色吗？此操作无法撤销。',
